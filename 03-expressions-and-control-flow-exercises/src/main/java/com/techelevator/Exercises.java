...
public class Exercises {
	...
	public boolean loneTeen(int a, int b) {
		...
		if(((a <= 19 && a >= 13) && (b < 13 || b > 19)) || ((b <= 19 && b >= 13) && (a < 13 || a > 19)))
		return true;
		return false;
	}
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		if((cigars <= 60 && cigars >= 40 && !isWeekend) || (cigars >= 40 && isWeekend))
			return true;
		return false;
	}
	...
	public boolean squirrelPlay(int temp, boolean isSummer) {
		...
		if((temp <= 90 && temp >= 60 && !isSummer) || (temp <=100 && temp >= 60 && isSummer))
			return true;	
		return false;
	}
	...
	public int caughtSpeeding(int speed, boolean isBirthday) {
		...
		if((speed <= 60) || (speed <= 65 && isBirthday))
			return 0;
		else if((speed >= 61 && speed <= 81) || (speed >= 66 && speed <= 85 && isBirthday))
			return 1;
		return 2;
	}
